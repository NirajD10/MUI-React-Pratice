import { Article, Home, PeopleAlt, PeopleOutline, Settings, Storefront } from '@mui/icons-material'
        ...
        <Box p={2} flex={1} sx={{ display: { xs: "none", sm: "block" } }}>
            <Box position="fixed">
                <List>
                    ...
                    <ListItem disablePadding>
                        <MaterialUISwitch sx={{ m: 1 }} onChange={() => props.setMode(props.mode === 'dark' ? 'light' : 'dark')} />
